...
RSpec.describe PagesController, type: :controller do
  ...
  describe "using fixtures" do
  	...
  	it "user is valid" do
      user = build(:user)                      # added110417
  		# user = users(:peter)                     commentout110417
  		# room = rooms(:sydney)                    commentout110417
  		# booking = bookings(:jamies_booking)      commentout110417
#require 'pry'; binding.pry
 require 'pry' ; user.pry                          #added110417
  	end
